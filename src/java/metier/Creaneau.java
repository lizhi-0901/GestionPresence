...
/**
 * Creaneau generated by hbm2java
 */
public class Creaneau  implements java.io.Serializable {
    ...
    public Creaneau(String idCreneau, Matiere matiere, String nomCreneau, String salle, String enseignant, Date dateDeb, int heureDeb, int duree, String typeActivite, String commantaire) {
    ...
    public Creaneau(String idCreneau, Matiere matiere, String nomCreneau, String salle, String enseignant, Date dateDeb, int heureDeb, int duree, String typeActivite, String commantaire, Set affecters, Set groupes) {
       this.idCreneau = idCreneau;
       this.matiere = matiere;
       this.nomCreneau = nomCreneau;
       this.salle = salle;
